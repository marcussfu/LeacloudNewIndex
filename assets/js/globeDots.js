...
const props = {
  ...
  startingCountry: 'taiwan', // The key of the country to rotate the camera to during the introduction animation (and which country to start the cycle at)
  colours: {
    // Cache the colours
...
const getData = async () => {
  ...
  $.getJSON( "assets/vendor/json/globe-points.json", function( responseJson ) {
    data = responseJson;
    setupScene();
  });
};
